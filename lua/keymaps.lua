...
-- and for colemak-dh, and everything other than 'big' qwerty
vim.keymap.set('n', '<C-M-Left>', '<C-w><C-h>', { desc = 'Move focus to left window' })
vim.keymap.set('n', '<C-M-Right>', '<C-w><C-l>', { desc = 'Move focus to right window' })
vim.keymap.set('n', '<C-M-Down>', '<C-w><C-j>', { desc = 'Move focus to lower window' })
vim.keymap.set('n', '<C-M-Up>', '<C-w><C-k>', { desc = 'Move focus to upper window' })
